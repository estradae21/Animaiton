package com.ernestoestrada.animaiton
...
import com.ernestoestrada.animaiton.R.id.*
import com.ernestoestrada.animaiton.R.string.bounce_recolor
...
*/
            ...
            bounce_color_animation -> {
                cb!!.setStyle(ChalkBoard.BOUNCE_RECOLOR)

                return true
            }

            rotate_color_animation -> {
                cb!!.setStyle(ChalkBoard.ROTATE_COLOR)
            }
